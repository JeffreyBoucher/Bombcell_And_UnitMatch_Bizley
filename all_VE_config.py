...
if projectLabel == 'Jeffrey':
    ...
    session_path = Path('D:/Neuropixels/' + ferret) # bombcell at least doesn't easily work read-only so having a local place for the raw data is better... And honestly this is maybe a good idea anyway, it's faster.
    ...
    behavior_path = Path("C:/Users/BizLab/Dropbox/Data/" +ferret)